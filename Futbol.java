...
class Futbol extends Game {
	...
	public Futbol() {
		...
		// Creating the home and away teams
 ...
 * It stores the team name and the current score of the Home Team. Instances of this
 ...
 * It stores the team name and the current score of the Away Team. Instances of this
...
class AwayTeam {
    int score;
    /**
     * Constructs a new AwayTeam instance.
     * Initializes the score to zero.
     * 
     */
    public AwayTeam() {
